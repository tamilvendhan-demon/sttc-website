    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        <Link href="#home" className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#0b3733] text-sm font-semibold text-white">
            ST
          </div>
          <div>
        ...
        <div className="hidden md:block">
          <Link href="#contact" className="rounded-full bg-[#0b3733] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#155a50]">
            Book Consultation
          </Link>
        </div>
      ...
      {isOpen ? (
        <div className="border-t border-slate-200 bg-white px-6 py-4 md:hidden">
          <div className="flex flex-col gap-3">
            ...
            <Link href="#contact" className="rounded-full bg-[#0b3733] px-4 py-2 text-center text-sm font-semibold text-white" onClick={() => setIsOpen(false)}>
              Book Consultation
            </Link>
          </div>
        </div>
